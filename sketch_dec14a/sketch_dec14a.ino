...
//---------------------------------------------------------------------
/*
// funcao com o codigo da pagina web
String text = "";
double data;
char page[] PROGMEM = R"=====(
...
<html lang="pt-br">
  ...
  <body>
    <h1>Sensor to Node MCU Web Server</h1><h1>Data:</h1> <h1 id=\"data\">""</h1>
  </body>
</html>
)=====";
*/
...
void setup() {
  ...
  */
  ...
  { 
   text = (String)data;
  request->send_P(200, "text/html", page);//'page' é o nome da função que contem a pagina web
  });
  */
  //------------------Led 1------------------------------------
